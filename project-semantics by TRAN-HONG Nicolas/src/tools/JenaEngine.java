...
//		 create an empty model
   ...
   /**
     ...
     * + Sortie: 
     */
    static public void readObjectType(Model model, String namespace, String objectName, String propertyName) {
        Resource rs = model.getResource(namespace + objectName);
        Property p = model.getProperty(namespace + propertyName);
        Property name = model.getProperty(namespace + "name");
        if ((rs != null) && (p != null)) {
        	//list all the values of the properties p and return an iterator
        	StmtIterator iterator = rs.listProperties(p);
            if(iterator == null) {
            	System.out.println(objectName + " " + propertyName + " null");
            }else {
            	System.out.print(objectName + " " + propertyName);
            	while(iterator.hasNext()) {
            		Statement statement = iterator.next();
            		Resource rs2 = statement.getResource();
            		//Return the localname of this resource
            		System.out.print(" " + rs2.getLocalName());
            	}
            	System.out.println("");
            }
    ...
    static public void readDataType(Model model, String namespace, String objectName, String propertyName) {
        ...
        if ((rs != null) && (p != null)) {
        	if(rs.getProperty(p) != null) {
            	System.out.println(propertyName + " of " + objectName +" : " + rs.getProperty(p).getString());
            }else {
            	System.out.println(propertyName + " of " + objectName +" : null");
            }
